...
#         "http://administracion.uniandes.edu.co/",
    ...
    rules = (
        ...
        Rule(SgmlLinkExtractor(allow=(), deny=(r'eventos\.uniandes\.edu\.co/', ), restrict_xpaths=('//*[contains(translate(@href, "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"),"event")]',))),
