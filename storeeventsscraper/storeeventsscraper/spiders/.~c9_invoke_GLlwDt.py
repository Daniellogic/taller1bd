...
#         "http://administracion.uniandes.edu.co/",
    ...
    rules = (
        ...
        Rule(SgmlLinkExtractor(allow=(), deny_domains=["http://eventos.uniandes.edu.co/"],restrict_xpaths=('//*[contains(translate(@class, "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "abcdefghijklmnopqrstuvwxyz"),"ev_link_row")]',)),callback="parse_items"),
